...
public class CheckSessionKeyService {
	...
	public void checkSessionKey(Date sessionDB,String email) throws IkmEngineException {
		...
		if(minutes>=Constants.TIMEOUT_IN_MINUTES){
			...
			throw new IkmEngineException(IkmEngineException.ENGINE_SESSION_KEY_EXPIRED);		
		}
