...
public class SharedPreferencesUtils {
	...
	private static SharedPreferences getPreferences(Context context) {
	    return context.getSharedPreferences(com.ikm.data.Constants.PARKING_PREFERENCE, 
	...
	public static void saveLoginData(String loginData,Context ctx){    	
		...
		editor.putString(com.ikm.data.Constants.LOGIN_DATA_PREF, loginData);
		editor.commit();
    }
	...
	public static LoginData getLoginData(Context ctx) {
		...
		try {		   	
		String ld = getPreferences(ctx).getString(com.ikm.data.Constants.LOGIN_DATA_PREF, "");
