package com.ikm.myagenda.view.pzv;
...
public class PullToZoomScrollViewEx extends PullToZoomBase<ScrollView> {
    ...
    private boolean isCustomHeaderHeight = false;//�?‡Şĺ®šäą‰headeré«�ĺş¦äą‹ĺ�ŽĺŹŻ�?��?ĺŻĽ�?‡´zoomViewć‹‰äĽ¸ä¸Ťć­�?çˇ®
